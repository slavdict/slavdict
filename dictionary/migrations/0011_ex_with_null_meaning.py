...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Example.meaning'
        db.alter_column('dictionary_example', 'meaning_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dictionary.Meaning'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Example.meaning'
        raise RuntimeError("Cannot reverse this migration. 'Example.meaning' and its values cannot be restored.")
