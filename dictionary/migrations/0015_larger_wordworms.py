...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Entry.sg1'
        db.alter_column('dictionary_entry', 'sg1', self.gf('django.db.models.fields.CharField')(max_length=30))

        # Changing field 'Entry.sg2'
        db.alter_column('dictionary_entry', 'sg2', self.gf('django.db.models.fields.CharField')(max_length=30))

        # Changing field 'Entry.short_form'
        db.alter_column('dictionary_entry', 'short_form', self.gf('django.db.models.fields.CharField')(max_length=30))


    def backwards(self, orm):
        
        # Changing field 'Entry.sg1'
        db.alter_column('dictionary_entry', 'sg1', self.gf('django.db.models.fields.CharField')(max_length=20))

        # Changing field 'Entry.sg2'
        db.alter_column('dictionary_entry', 'sg2', self.gf('django.db.models.fields.CharField')(max_length=20))

        # Changing field 'Entry.short_form'
        db.alter_column('dictionary_entry', 'short_form', self.gf('django.db.models.fields.CharField')(max_length=20))
