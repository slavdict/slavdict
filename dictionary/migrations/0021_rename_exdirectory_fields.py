...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_column('dictionary_entry', 'DMG_participle_type', 'participle_type')
        db.rename_column('dictionary_entry', 'DMG_transitivity', 'transitivity')
        db.rename_column('dictionary_entry', 'DMG_onym', 'onym')
        db.rename_column('dictionary_entry', 'DMG_status', 'status')
        db.rename_column('dictionary_entry', 'DMG_part_of_speech', 'part_of_speech')
        db.rename_column('dictionary_entry', 'DMG_gender', 'gender')
        db.rename_column('dictionary_entry', 'DMG_tantum', 'tantum')
        db.rename_column('dictionary_meaning', 'DMG_substantivus_type', 'substantivus_type')
        db.rename_column('dictionary_etymology', 'DMG_language', 'language')

    def backwards(self, orm):
        db.rename_column('dictionary_entry', 'participle_type', 'DMG_participle_type')
        db.rename_column('dictionary_entry', 'transitivity', 'DMG_transitivity')
        db.rename_column('dictionary_entry', 'onym', 'DMG_onym')
        db.rename_column('dictionary_entry', 'status', 'DMG_status')
        db.rename_column('dictionary_entry', 'part_of_speech', 'DMG_part_of_speech')
        db.rename_column('dictionary_entry', 'gender', 'DMG_gender')
        db.rename_column('dictionary_entry', 'tantum', 'DMG_tantum')
        db.rename_column('dictionary_meaning', 'substantivus_type', 'DMG_substantivus_type')
        db.rename_column('dictionary_etymology', 'language', 'DMG_language')
