...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Entry.civil_equivalent'
        db.alter_column('dictionary_entry', 'civil_equivalent', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'Collocation.civil_equivalent'
        db.alter_column('dictionary_collocation', 'civil_equivalent', self.gf('django.db.models.fields.CharField')(max_length=50))


    def backwards(self, orm):
        
        # Changing field 'Entry.civil_equivalent'
        db.alter_column('dictionary_entry', 'civil_equivalent', self.gf('django.db.models.fields.CharField')(max_length=40))

        # Changing field 'Collocation.civil_equivalent'
        db.alter_column('dictionary_collocation', 'civil_equivalent', self.gf('django.db.models.fields.CharField')(max_length=40))
