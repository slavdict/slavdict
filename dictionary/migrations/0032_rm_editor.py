...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Entry.editor'
        db.delete_column(u'dictionary_entry', 'editor_id')


    def backwards(self, orm):
        # Adding field 'Entry.editor'
        db.add_column(u'dictionary_entry', 'editor',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='old_editors', null=True, to=orm['custom_user.CustomUser'], blank=True),
                      keep_default=False)
