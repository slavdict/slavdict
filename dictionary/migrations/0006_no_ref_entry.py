...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'OrthographicVariant.no_ref_entry'
        db.add_column('dictionary_orthographicvariant', 'no_ref_entry', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'OrthographicVariant.no_ref_entry'
        db.delete_column('dictionary_orthographicvariant', 'no_ref_entry')
