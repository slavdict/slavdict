...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Entry.reconstructed_headword'
        db.add_column('dictionary_entry', 'reconstructed_headword', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Entry.questionable_headword'
        db.add_column('dictionary_entry', 'questionable_headword', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Deleting field 'OrthographicVariant.frequency'
        db.delete_column('dictionary_orthographicvariant', 'frequency')


    def backwards(self, orm):
        
        # Deleting field 'Entry.reconstructed_headword'
        db.delete_column('dictionary_entry', 'reconstructed_headword')

        # Deleting field 'Entry.questionable_headword'
        db.delete_column('dictionary_entry', 'questionable_headword')

        # Adding field 'OrthographicVariant.frequency'
        db.add_column('dictionary_orthographicvariant', 'frequency', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True), keep_default=False)
