...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Entry.grequiv_status'
        db.delete_column('dictionary_entry', 'grequiv_status')


    def backwards(self, orm):
        
        # Adding field 'Entry.grequiv_status'
        db.add_column('dictionary_entry', 'grequiv_status', self.gf('django.db.models.fields.CharField')(max_length=1, null=True, blank=True), keep_default=False)
