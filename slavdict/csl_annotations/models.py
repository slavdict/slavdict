...
MOSTLY_FOR_VIDEOS = u'''
    ...
    Обязательно для видео, факультативно для книг и статей.
    Ручное указание авторства в этом поле не приветствуется, так как
    автор автоматически будет добавлен (если он выделен галочкой в поле
