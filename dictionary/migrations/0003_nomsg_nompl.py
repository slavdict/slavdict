...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming field 'ProperNoun.nom_sg'
        db.rename_column('dictionary_propernoun', 'nom_sg', 'nom_pl')

    def backwards(self, orm):
        
        # Renaming field 'ProperNoun.nom_pl'
        db.rename_column('dictionary_propernoun', 'nom_pl', 'nom_sg')
