...
special_cases = [
    ...
    { 'startswith': [C("госпо'дьс")],
      ...
      'qv': [{ 'qv': С("госпо'дс"), 'dots': True }] },

    # губител... см. губитель...  [губителный, губителство]
    { 'startswith': [С("гꙋби'тел")],
      'refs': [{ C("гꙋби'тел"), 'dots': True }] },
      'qv': [{ C("гꙋби'тель"), 'dots': True }] },

    # девор... и девwра см. деввwра.  [девора, деворра, девwра]
    { 'startswith': [С("дево'р"), C("девѡ'р")],
      'ref': [
          { 'ref': С("дево'р"), 'dots': True },
    ...
    { 'startswith': [С("дѣ'тищ")],
      'ref': [
          { 'ref': С("дѣ'тищъ"), 'dots': False },
          { 'ref': C("дѣ'тище"), 'dots': False },
      ],
      'qv': [{ 'qv': C("дѣ'тищь"), 'dots': False }] },

    # доволн... см. довольн...  [доволне, доволно, доволнw, доволный]
    { 'startswith': [С("дово'лн")],
      'ref': [{ 'ref': С("дово'лн"), 'dots': True }],
      'qv': [{ 'qv': С("дово'льн"), 'dots': True }] },

    # долн... см. дольний.  [долный, долний]
    { 'startswith': [С("до'лн")],
      'ref': [{ 'ref': С("до'лн"), 'dots': True }],
      'qv': [{ 'qv': С("до'льній"), 'dots': False }] },

    # еврее и евреи см. евреанин, евреин.  [еврее, евреи]
    { 'startswith': [C("євре'є"), С("євре'и")],
      'ref': [
          { 'ref': C("євре'є"), 'dots': False },
          { 'ref': C("євре'и"), 'dots': False },
      ],
      'qv': [
          { 'qv': С("євре'анинъ"), 'dots': False },
          { 'qv': С("євре'инъ"), 'dots': False }
      ] },
