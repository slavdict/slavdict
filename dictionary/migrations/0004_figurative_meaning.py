...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Meaning.figurative'
        db.add_column(u'dictionary_meaning', 'figurative',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Meaning.figurative'
        db.delete_column(u'dictionary_meaning', 'figurative')
    ...
    models = {
        ...
        u'dictionary.entry': {
            ...
            'part_of_speech': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '1', 'blank': 'True'}),
        ...
        u'dictionary.meaning': {
            ...
            'figurative': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
