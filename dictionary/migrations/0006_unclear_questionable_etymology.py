...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming field 'Etymology.unclear_etymology' to 'Etymology.unclear'
        db.rename_column('dictionary_etymology', 'unclear_etymology', 'unclear')

        # Adding field 'Etymology.questionable'
        db.add_column('dictionary_etymology', 'questionable', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Etymology.questionable'
        db.delete_column('dictionary_etymology', 'questionable')

        # Renaming field 'Etymology.unclear' to 'Etymology.unclear_etymology'
        db.rename_column('dictionary_etymology', 'unclear', 'unclear_etymology')
    ...
    models = {
        ...
        'dictionary.collocationgroup': {
            ...
            'cf_meanings': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'cf_meanings_rel_+'", 'null': 'True', 'to': "orm['dictionary.CollocationGroup']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'dictionary.entry': {
            ...
            'cf_entries': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'cf_entries_rel_+'", 'null': 'True', 'to': "orm['dictionary.Entry']"}),
        ...
        'dictionary.meaning': {
            ...
            'cf_meanings': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'cf_meanings_rel_+'", 'null': 'True', 'to': "orm['dictionary.Meaning']"}),
