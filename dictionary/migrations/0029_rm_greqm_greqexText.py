...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(u'dictionary_greekequivalentformeaning')

        # Deleting field 'GreekEquivalentForExample.text'
        db.delete_column(u'dictionary_greekequivalentforexample', 'text')


    def backwards(self, orm):
        # Adding model 'GreekEquivalentForMeaning'
        db.create_table(u'dictionary_greekequivalentformeaning', (
        ...
        # Adding field 'GreekEquivalentForExample.text'
        db.add_column(u'dictionary_greekequivalentforexample', 'text',
    ...
    models = {
        ...
        u'dictionary.entry': {
            ...
            'editor': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['custom_user.CustomUser']", 'null': 'True', 'blank': 'True'}),
