...
def special_cases_func(self, case):
    ...
    if case == 'several nouns':
        ...
        elif self.civil_equivalent in ('дрождие', 'дрожди'):
            base_vars = tuple(self.base_vars)
            tags = (
                {'text': base_vars[0].idem_ucs, 'class': 'Headword'},
                {'text': ',', 'class': 'Text'},
        ...
        elif self.civil_equivalent in ('ефиоп', 'ефиопс'):
            base_vars = tuple(self.base_vars)
            tags = (
                {'text': base_vars[0].idem_ucs, 'class': 'Headword'},
                {'text': ',', 'class': 'Text'},
        ...
        elif self.civil_equivalent == 'ефиоплянин':
            base_vars = tuple(self.base_vars)
            tags = (
                {'text': base_vars[0].idem_ucs, 'class': 'Headword'},
                {'text': ',', 'class': 'Text'},
                ...
                {'text': ',', 'class': 'Text'},
                {'text': ts.SPACE},
                {'text': self.ethnonyms[0][1], 'class': 'CSLSegment'},
                {'text': ts.SPACE},
                {'text': '(', 'class': 'Text'},
                {'text': self.ethnonyms[1][1], 'class': 'CSLSegment'},
                {'text': ')', 'class': 'Text'},
                {'text': ts.SPACE},
                {'text': 'мн.', 'class': 'Em'},
                {'text': ts.SPACE},
