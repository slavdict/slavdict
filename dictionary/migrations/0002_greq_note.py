...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GreekEquivalentForExample.note'
        db.add_column(u'dictionary_greekequivalentforexample', 'note',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GreekEquivalentForExample.note'
        db.delete_column(u'dictionary_greekequivalentforexample', 'note')
