...
#        )
    ...
    preplock = False  # Заглушка для ф-ции, различающая пользователей,
        # занимающихся подготовкой тома к печати (False), и остальных (True).
        # На время за рамками подготовки того или иного тома к печати такой
        # сегрегации пользователей не произодим, поэтому для всех False.
