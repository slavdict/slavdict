...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('dictionary_entry', 'onym', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['directory.CategoryValue'], null=True, blank=True), keep_default=False)

        # Adding field 'Entry.canonical_name'
        db.add_column('dictionary_entry', 'canonical_name', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Entry.nom_sg'
        db.add_column('dictionary_entry', 'nom_sg', self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True), keep_default=False)

        # Adding field 'Entry.nom_pl'
        db.add_column('dictionary_entry', 'nom_pl', self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Entry.canonical_name'
        db.delete_column('dictionary_entry', 'canonical_name')

        # Deleting field 'Entry.nom_sg'
        db.delete_column('dictionary_entry', 'nom_sg')

        # Deleting field 'Entry.nom_pl'
        db.delete_column('dictionary_entry', 'nom_pl')
