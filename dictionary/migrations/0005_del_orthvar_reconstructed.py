...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'OrthographicVariant.is_reconstructed'
        db.delete_column('dictionary_orthographicvariant', 'is_reconstructed')

        # Deleting field 'OrthographicVariant.is_approved'
        db.delete_column('dictionary_orthographicvariant', 'is_approved')


    def backwards(self, orm):
        
        # Adding field 'OrthographicVariant.is_reconstructed'
        db.add_column('dictionary_orthographicvariant', 'is_reconstructed', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'OrthographicVariant.is_approved'
        db.add_column('dictionary_orthographicvariant', 'is_approved', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
