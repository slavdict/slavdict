...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'GreekUnicode.initial_form'
        db.add_column('dictionary_greekunicode', 'initial_form', self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'GreekUnicode.initial_form'
        db.delete_column('dictionary_greekunicode', 'initial_form')
