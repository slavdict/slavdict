...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Example.entry'
        db.add_column('dictionary_example', 'entry',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dictionary.Entry'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Example.collogroup'
        db.add_column('dictionary_example', 'collogroup',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dictionary.CollocationGroup'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Example.entry'
        db.delete_column('dictionary_example', 'entry_id')

        # Deleting field 'Example.collogroup'
        db.delete_column('dictionary_example', 'collogroup_id')
