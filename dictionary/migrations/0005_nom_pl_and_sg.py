...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ProperNoun.nom_sg'
        db.add_column('dictionary_propernoun', 'nom_sg', self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ProperNoun.nom_sg'
        db.delete_column('dictionary_propernoun', 'nom_sg')
