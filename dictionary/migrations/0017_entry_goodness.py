...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Entry.good'
        db.add_column('dictionary_entry', 'good',
                      self.gf('django.db.models.fields.TextField')(default=u'b', max_length=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Entry.good'
        db.delete_column('dictionary_entry', 'good')
