...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('dictionary_collocationgroup_cf_meanings', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('from_collocationgroup', models.ForeignKey(orm['dictionary.collocationgroup'], null=False)),
            ('to_collocationgroup', models.ForeignKey(orm['dictionary.collocationgroup'], null=False))
        ))
        db.create_unique('dictionary_collocationgroup_cf_meanings', ['from_collocationgroup_id', 'to_collocationgroup_id'])
