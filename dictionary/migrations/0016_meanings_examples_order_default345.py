...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Example.order'
        db.add_column('dictionary_example', 'order',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=345, blank=True),
                      keep_default=False)

        # Adding field 'Meaning.order'
        db.add_column('dictionary_meaning', 'order',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=345, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Example.order'
        db.delete_column('dictionary_example', 'order')

        # Deleting field 'Meaning.order'
        db.delete_column('dictionary_meaning', 'order')
