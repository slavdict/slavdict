...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'GreekEquivalentForMeaning.source'
        db.add_column('dictionary_greekequivalentformeaning', 'source', self.gf('django.db.models.fields.CharField')(default='', max_length=40, blank=True), keep_default=False)

        # Adding field 'Etymology.source'
        db.add_column('dictionary_etymology', 'source', self.gf('django.db.models.fields.CharField')(default='', max_length=40, blank=True), keep_default=False)

        # Adding field 'GreekEquivalentForExample.source'
        db.add_column('dictionary_greekequivalentforexample', 'source', self.gf('django.db.models.fields.CharField')(default='', max_length=40, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'GreekEquivalentForMeaning.source'
        db.delete_column('dictionary_greekequivalentformeaning', 'source')

        # Deleting field 'Etymology.source'
        db.delete_column('dictionary_etymology', 'source')

        # Deleting field 'GreekEquivalentForExample.source'
        db.delete_column('dictionary_greekequivalentforexample', 'source')
