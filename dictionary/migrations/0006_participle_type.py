...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('dictionary_entry', 'participle_type', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='entries_of_parttype', null=True, to=orm['directory.CategoryValue']), keep_default=False)
