...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Etymology.language'
        db.delete_column('dictionary_etymology', 'language_id')

        # Deleting field 'Entry.part_of_speech'
        db.delete_column('dictionary_entry', 'part_of_speech_id')

        # Deleting field 'Entry.onym'
        db.delete_column('dictionary_entry', 'onym_id')

        # Deleting field 'Entry.gender'
        db.delete_column('dictionary_entry', 'gender_id')

        # Deleting field 'Entry.tantum'
        db.delete_column('dictionary_entry', 'tantum_id')

        # Deleting field 'Entry.status'
        db.delete_column('dictionary_entry', 'status_id')

        # Deleting field 'Entry.participle_type'
        db.delete_column('dictionary_entry', 'participle_type_id')

        # Deleting field 'Entry.transitivity'
        db.delete_column('dictionary_entry', 'transitivity_id')

        # Deleting field 'Meaning.substantivus_type'
        db.delete_column('dictionary_meaning', 'substantivus_type_id')


    def backwards(self, orm):
        # Adding field 'Etymology.language'
        db.add_column('dictionary_etymology', 'language',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['directory.CategoryValue']),
                      keep_default=False)

        # Adding field 'Entry.part_of_speech'
        db.add_column('dictionary_entry', 'part_of_speech',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='entries_of_pos', null=True, to=orm['directory.CategoryValue']),
                      keep_default=False)

        # Adding field 'Entry.onym'
        db.add_column('dictionary_entry', 'onym',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['directory.CategoryValue'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Entry.gender'
        db.add_column('dictionary_entry', 'gender',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='entries_of_gender', null=True, to=orm['directory.CategoryValue'], blank=True),
                      keep_default=False)

        # Adding field 'Entry.tantum'
        db.add_column('dictionary_entry', 'tantum',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='entries_of_tantum', null=True, to=orm['directory.CategoryValue'], blank=True),
                      keep_default=False)

        # Adding field 'Entry.status'
        db.add_column('dictionary_entry', 'status',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='entries_of_status', null=True, to=orm['directory.CategoryValue'], blank=True),
                      keep_default=False)

        # Adding field 'Entry.participle_type'
        db.add_column('dictionary_entry', 'participle_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='entries_of_parttype', null=True, to=orm['directory.CategoryValue'], blank=True),
                      keep_default=False)

        # Adding field 'Entry.transitivity'
        db.add_column('dictionary_entry', 'transitivity',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='entries_of_transitivity', null=True, to=orm['directory.CategoryValue'], blank=True),
                      keep_default=False)

        # Adding field 'Meaning.substantivus_type'
        db.add_column('dictionary_meaning', 'substantivus_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['directory.CategoryValue'], null=True, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        'dictionary.entry': {
            'DMG_gender': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '1', 'blank': 'True'}),
            'DMG_onym': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '1', 'blank': 'True'}),
            'DMG_part_of_speech': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '1'}),
            'DMG_participle_type': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '1', 'blank': 'True'}),
            'DMG_status': ('django.db.models.fields.CharField', [], {'default': "'c'", 'max_length': '1'}),
            'DMG_tantum': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '1', 'blank': 'True'}),
            'DMG_transitivity': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '1', 'blank': 'True'}),
        ...
        'dictionary.etymology': {
            'DMG_language': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '1'}),
        ...
        'dictionary.meaning': {
            'DMG_substantivus_type': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '1', 'blank': 'True'}),
