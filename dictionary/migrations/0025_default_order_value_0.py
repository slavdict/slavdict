...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Participle.order'
        db.alter_column('dictionary_participle', 'order', self.gf('django.db.models.fields.SmallIntegerField')())

        # Changing field 'MeaningContext.order'
        db.alter_column('dictionary_meaningcontext', 'order', self.gf('django.db.models.fields.SmallIntegerField')())

        # Changing field 'Etymology.order'
        db.alter_column('dictionary_etymology', 'order', self.gf('django.db.models.fields.SmallIntegerField')())

        # Changing field 'OrthographicVariant.order'
        db.alter_column('dictionary_orthographicvariant', 'order', self.gf('django.db.models.fields.SmallIntegerField')())

        # Changing field 'Collocation.order'
        db.alter_column('dictionary_collocation', 'order', self.gf('django.db.models.fields.SmallIntegerField')())

    def backwards(self, orm):

        # Changing field 'Participle.order'
        db.alter_column('dictionary_participle', 'order', self.gf('django.db.models.fields.SmallIntegerField')(null=True))

        # Changing field 'MeaningContext.order'
        db.alter_column('dictionary_meaningcontext', 'order', self.gf('django.db.models.fields.SmallIntegerField')(null=True))

        # Changing field 'Etymology.order'
        db.alter_column('dictionary_etymology', 'order', self.gf('django.db.models.fields.SmallIntegerField')(null=True))

        # Changing field 'OrthographicVariant.order'
        db.alter_column('dictionary_orthographicvariant', 'order', self.gf('django.db.models.fields.SmallIntegerField')(null=True))

        # Changing field 'Collocation.order'
        db.alter_column('dictionary_collocation', 'order', self.gf('django.db.models.fields.SmallIntegerField')(null=True))
