...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MeaningContext.left_text'
        db.alter_column('dictionary_meaningcontext', 'left_text', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'MeaningContext.right_text'
        db.alter_column('dictionary_meaningcontext', 'right_text', self.gf('django.db.models.fields.CharField')(max_length=50))


    def backwards(self, orm):
        
        # Changing field 'MeaningContext.left_text'
        db.alter_column('dictionary_meaningcontext', 'left_text', self.gf('django.db.models.fields.CharField')(max_length=20))

        # Changing field 'MeaningContext.right_text'
        db.alter_column('dictionary_meaningcontext', 'right_text', self.gf('django.db.models.fields.CharField')(max_length=20))
