...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Example.greek_eq_status'
        db.add_column('dictionary_example', 'greek_eq_status', self.gf('django.db.models.fields.CharField')(default=u'L', max_length=1), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Example.greek_eq_status'
        db.delete_column('dictionary_example', 'greek_eq_status')
