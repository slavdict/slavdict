...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'GreekEquivalentForMeaning.additional_info'
        db.add_column('dictionary_greekequivalentformeaning', 'additional_info', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Adding field 'GreekEquivalentForExample.additional_info'
        db.add_column('dictionary_greekequivalentforexample', 'additional_info', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'GreekEquivalentForMeaning.additional_info'
        db.delete_column('dictionary_greekequivalentformeaning', 'additional_info')

        # Deleting field 'GreekEquivalentForExample.additional_info'
        db.delete_column('dictionary_greekequivalentforexample', 'additional_info')
