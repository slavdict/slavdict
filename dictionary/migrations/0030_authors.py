...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'dictionary_entry_authors', (
        ...
        db.create_unique(u'dictionary_entry_authors', ['entry_id', 'customuser_id'])


    def backwards(self, orm):
        # Removing M2M table for field authors on 'Entry'
        db.delete_table('dictionary_entry_authors')
    ...
    models = {
        ...
        u'dictionary.entry': {
            ...
            'editor': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'old_editors'", 'null': 'True', 'to': u"orm['custom_user.CustomUser']"}),
