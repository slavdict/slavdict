...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CollocationGroup.additional_info'
        db.add_column(u'dictionary_collocationgroup', 'additional_info',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CollocationGroup.additional_info'
        db.delete_column(u'dictionary_collocationgroup', 'additional_info')
