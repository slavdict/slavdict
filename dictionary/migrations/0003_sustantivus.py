...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Meaning.substantivus'
        db.add_column('dictionary_meaning', 'substantivus', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['directory.CategoryValue'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Meaning.substantivus'
        db.delete_column('dictionary_meaning', 'substantivus_id')
    ...
    models = {
        ...
        'dictionary.meaning': {
            ...
            'substantivus': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['directory.CategoryValue']", 'null': 'True', 'blank': 'True'})
        },
