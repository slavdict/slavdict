...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('dictionary_meaning', 'substantivus', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Meaning.substantivus'
        db.delete_column('dictionary_meaning', 'substantivus')
