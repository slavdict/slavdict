...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Etymology.DMG_language'
        db.add_column('dictionary_etymology', 'DMG_language',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=1),
                      keep_default=False)

        # Adding field 'Entry.DMG_part_of_speech'
        db.add_column('dictionary_entry', 'DMG_part_of_speech',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=1),
                      keep_default=False)

        # Adding field 'Entry.DMG_tantum'
        db.add_column('dictionary_entry', 'DMG_tantum',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=1, blank=True),
                      keep_default=False)

        # Adding field 'Entry.DMG_gender'
        db.add_column('dictionary_entry', 'DMG_gender',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=1, blank=True),
                      keep_default=False)

        # Adding field 'Entry.DMG_onym'
        db.add_column('dictionary_entry', 'DMG_onym',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=1, blank=True),
                      keep_default=False)

        # Adding field 'Entry.DMG_transitivity'
        db.add_column('dictionary_entry', 'DMG_transitivity',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=1, blank=True),
                      keep_default=False)

        # Adding field 'Entry.DMG_participle_type'
        db.add_column('dictionary_entry', 'DMG_participle_type',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=1, blank=True),
                      keep_default=False)

        # Adding field 'Entry.DMG_status'
        db.add_column('dictionary_entry', 'DMG_status',
                      self.gf('django.db.models.fields.CharField')(default='c', max_length=1),
                      keep_default=False)

        # Adding field 'Meaning.DMG_substantivus_type'
        db.add_column('dictionary_meaning', 'DMG_substantivus_type',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=1, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Etymology.DMG_language'
        db.delete_column('dictionary_etymology', 'DMG_language')

        # Deleting field 'Entry.DMG_part_of_speech'
        db.delete_column('dictionary_entry', 'DMG_part_of_speech')

        # Deleting field 'Entry.DMG_tantum'
        db.delete_column('dictionary_entry', 'DMG_tantum')

        # Deleting field 'Entry.DMG_gender'
        db.delete_column('dictionary_entry', 'DMG_gender')

        # Deleting field 'Entry.DMG_onym'
        db.delete_column('dictionary_entry', 'DMG_onym')

        # Deleting field 'Entry.DMG_transitivity'
        db.delete_column('dictionary_entry', 'DMG_transitivity')

        # Deleting field 'Entry.DMG_participle_type'
        db.delete_column('dictionary_entry', 'DMG_participle_type')

        # Deleting field 'Entry.DMG_status'
        db.delete_column('dictionary_entry', 'DMG_status')

        # Deleting field 'Meaning.DMG_substantivus_type'
        db.delete_column('dictionary_meaning', 'DMG_substantivus_type')
