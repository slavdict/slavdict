...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GreekEquivalentForExample.order'
        db.add_column(u'dictionary_greekequivalentforexample', 'order',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=0, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GreekEquivalentForExample.order'
        db.delete_column(u'dictionary_greekequivalentforexample', 'order')
