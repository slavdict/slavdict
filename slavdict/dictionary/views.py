...
| `?mcsl-vs-entries` | Вместо статей отображать заглавное слово и список всех значений, употреблений и пояснений, где встречается цсл текст в двойных решетках (например, значение «название десятой буквы церковнославянской азбуки ##=и##»). |
